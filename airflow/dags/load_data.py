...
engine = create_engine('postgresql+psycopg2://airflow:airflow@postgres/trafficdatabase')
...
with DAG(
        dag_id = 'loading_data',
        description='Load data in postgres database',
        ...
        load_data = PythonOperator(
            task_id='load_car_tables',
            python_callable=insert_to_car_table
        )

        load_data2 = PythonOperator(
            task_id='load_traj_tables',
            python_callable=insert_to_traj_table
        )
